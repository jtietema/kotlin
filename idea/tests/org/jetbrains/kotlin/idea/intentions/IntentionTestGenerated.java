...
public class IntentionTestGenerated extends AbstractIntentionTest {
    ...
    public static class ConvertEnumToSealedClass extends AbstractIntentionTest {
        ...
        @TestMetadata("notOnClassId.kt")
        public void testNotOnClassId() throws Exception {
            String fileName = KotlinTestUtils.navigationMetadata("idea/testData/intentions/convertEnumToSealedClass/notOnClassId.kt");
            doTest(fileName);
        }
    }
    ...
    public static class ConvertSealedClassToEnum extends AbstractIntentionTest {
        ...
        @TestMetadata("notOnClassId.kt")
        public void testNotOnClassId() throws Exception {
            String fileName = KotlinTestUtils.navigationMetadata("idea/testData/intentions/convertSealedClassToEnum/notOnClassId.kt");
            doTest(fileName);
        }
