...
public enum PrimitiveBinaryOperationFIF implements FunctionIntrinsicFactory {
    ...
    @NotNull
    private static final FunctionIntrinsic RANGE_TO_INTRINSIC = new FqnCallIntrinsic("IntRange", true, Namer.INT_RANGE);

    @NotNull
    private static final FunctionIntrinsic CHAR_RANGE_TO_INTRINSIC = new FqnCallIntrinsic("CharRange", true, Namer.CHAR_RANGE);
